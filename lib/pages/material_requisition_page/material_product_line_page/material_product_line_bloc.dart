    ...
    try {
      ...
      Sharef.getOdooClientInstance().then((value) async {
        ...
        OdooResponse res = await odoo.searchRead(
            'purchase.requisition.product.line',
            [
              ['purchase_requisition_product_id', '=', id]
            ],
            [
              'id',
              'purchase_requisition_product_id',
              'product_id',
              // 'product_code',
              'qty',
              // 'product_uom_id',
  ...
  createMaterialProductLine({
    ...
    try {
      ...
      Sharef.getOdooClientInstance().then((value) async {
        ...
        odoo.setSessionId(value['session_id']);
        OdooResponse res =
            await odoo.create('purchase.requisition.product.line', {
          'purchase_requisition_product_id': materialproductId,
