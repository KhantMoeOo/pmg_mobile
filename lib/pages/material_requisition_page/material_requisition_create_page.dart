    ...
    return SafeArea(
                                  ...
                                  [
                                    ...
                                    Container(
                                      ...
                                      child: StreamBuilder<ResponseOb>(
                                          initialData: hasHrEmployeeData ==
                                                  false
                                              ? ResponseOb(
                                                  msgState: MsgState.loading)
                                              : null,
                                          stream:
                                              profileBloc.getHrEmployeeStream(),
                                          builder: (context,
                      ...
                      child: Image.asset(
                        ...
                        height: 50,
                                    ...
                                    Container(
                                      ...
                                      height: 40,
                                      child: StreamBuilder<ResponseOb>(
                                          initialData: hasHrDepartmentData ==
                                                  false
                                              ? ResponseOb(
                                                  msgState: MsgState.loading)
                                              : null,
                                              ...
                                              return DropdownSearch<String>(
                                                ...
                                                items: hrdepartmentList
                                                    .map((e) =>
                                                        '${e['id']},${e['name']}')
                                                    .toList(),
                                                onChanged: getHrDepartmentId,
                                                selectedItem: hrdepartmentName,
                                              );
                                            }
                                          }),
                                    ),
                      ...
                      child: Image.asset(
                        ...
                        height: 50,
                                    ...
                                    Container(
                                      color: Colors.white,
                                      child: StreamBuilder<ResponseOb>(
                                          initialData: hasInvoiceData == true
                                              ? null
                                              : ResponseOb(
                                                  msgState: MsgState.loading),
                                          stream: deliveryBloc
                        ...
                        height: 50,
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                          fontSize: 20,
                                          fontWeight: FontWeight.bold,
                                          color: hasNotScheduledDate == true
                                              ? Colors.red
                                              : Colors.black),
                                    ),
                                    Container(
                                    ...
                                    Container(
                                      ...
                                      height: 40,
                                      child: StreamBuilder<ResponseOb>(
                                          initialData: hasStockLocationData ==
                                                  true
                                              ? null
                                              : ResponseOb(
                                                  msgState: MsgState.loading),
      ...
      isCreateMaterialProductLine == true
          ? StreamBuilder<ResponseOb>(
              initialData: ResponseOb(msgState: MsgState.loading),
              stream:
                  materialproductlineBloc.getMaterialProductLineCreateStream(),
              builder: (context, AsyncSnapshot<ResponseOb> snapshot) {
                ResponseOb? responseOb = snapshot.data;
                if (responseOb?.msgState == MsgState.loading) {
                  return Container(
