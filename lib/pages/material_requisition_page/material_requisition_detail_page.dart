...
class _MaterialRequisitionDetailPageState
  ...
  Future<void> getproductlineListFromDB() async {
    ...
    for (var element in productlineList) {
      if (element['purchase_requisition_product_id'][0] == widget.id) {
        print('ORderId?????: ${element['purchase_requisition_product_id']}');
  ...
  void getMaterialRequisitionListen(ResponseOb responseOb) {
    if (responseOb.msgState == MsgState.data) {
      ...
      print('materialRequList____________ ${materialRequisitionList}');
                        ...
                        children: [
                          Scaffold(
                              ...
                              appBar: AppBar(
                                ...
                                title: Text(
                                    '${materialRequisitionList[0]['request_person_id'][1]}'),
                                actions: [
                                  Visibility(
                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                              child: Column(
                                                                  ...
                                                                  children: const [
                                                                Text(
                                                                  'N/A', //materialproductlineDBList![i].description
                                                                  style: TextStyle(
                                                                      color: Colors
                                                                          .black,
                                                                      fontSize:
                                                              ...
                                                              children: [
                                                                ...
                                                                Expanded(
                                                                    child: Column(
                                                                        ...
                                                                        children: const [
                                                                      Text(
                                                                          'N/A', //${materialRequisitionList[0]['ref_no'] == false ? '-' : materialRequisitionList[0]['ref_no']}
                                                                          style: TextStyle(
                                                                              color: Colors.black,
                                                                              fontSize: 18))
                                                                    ])),
                                                              ...
                                                              children: [
                                                                ...
                                                                Expanded(
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                      Text(
                                                                          '${materialRequisitionList[0]['request_person_id'][1] == false ? '-' : materialRequisitionList[0]['request_person_id'][1]}',
                                                                          style: const TextStyle(
                                                                              color: Colors.black,
                                                                              fontSize: 18))
                                                                    ])),
                                                              ...
                                                              children: [
                                                                ...
                                                                Expanded(
                                                                    child: Column(
                                                                        ...
                                                                        children: const [
                                                                      Text(
                                                                          'N/A', //${materialRequisitionList[0]['zone_id'] == false ? '-' : materialRequisitionList[0]['zone_id'][1]}
                                                                          style: TextStyle(
                                                                              color: Colors.black,
                                                                              fontSize: 18))
                                                                    ])),
                                                                ...
                                                                Expanded(
                                                                  ...
                                                                  children: [
                                                                    Icon(
                                                                        Icons
                                                                            .star,
                                                                        color: materialRequisitionList[0]['priority'] ==
                                                                                'a'
                                                                            ? Colors.grey
                                                                            : Colors.yellow),
                                                                    Icon(
                                                                        Icons
                                                                            .star,
                                                                        color: materialRequisitionList[0]['priority'] == 'b' ||
                                                                                materialRequisitionList[0]['priority'] == 'a'
                                                                            ? Colors.grey
                                                                            : Colors.yellow),
                                                                    Icon(
                                                                        Icons
                                                                            .star,
                                                                        color: materialRequisitionList[0]['priority'] == 'c' ||
                                                                                materialRequisitionList[0]['priority'] == 'b' ||
                                                                                materialRequisitionList[0]['priority'] == 'a'
                                                                            ? Colors.grey
                                                                            : Colors.yellow),
                                                                    Icon(
                                                                        ...
                                                                        color: materialRequisitionList[0]['priority'] == 'f' ||
                                                                                materialRequisitionList[0]['priority'] == 'e'
                                                                            ? Colors.yellow
                                                                            : Colors.grey),
                                                                    Icon(
                                                                        Icons
                                                              ...
                                                              children: [
                                                                ...
                                                                Expanded(
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                      Text(
                                                                          '${materialRequisitionList[0]['required_date'] == false ? '-' : materialRequisitionList[0]['required_date']}',
                                                                          style: const TextStyle(
                                                                              color: Colors.black,
                                                                              fontSize: 18))
                                                                    ])),
