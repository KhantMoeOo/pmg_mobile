  ...
  getZoneListData() async {
    ...
    try {
      ...
      Sharef.getOdooClientInstance().then((value) async {
        ...
        odoo.setSessionId(value['session_id']);
        OdooResponse res =
            await odoo.searchRead('res.zone', [], ['id', 'name']);
        if (res.getResult() != null) {
  ...
  getSegmenListData() async {
    ...
    try {
      ...
      Sharef.getOdooClientInstance().then((value) async {
        ...
        odoo.setSessionId(value['session_id']);
        OdooResponse res =
            await odoo.searchRead('res.segment', [], ['id', 'name']);
        if (res.getResult() != null) {
  ...
  getZoneListWithUserIdData(id) async {
    ...
    try {
      ...
      Sharef.getOdooClientInstance().then((value) async {
        odoo = Odoo(BASEURL);
        odoo.setSessionId(value['session_id']);
        OdooResponse res = await odoo.searchRead('res.zone', [
          ['id', '=', id]
        ], [
          'id',
          'name'
