    ...
    for (var element in invoiceLineList) {
      if (element['exclude_from_invoice_tab'] == false) {
        final invoicelineOb = InvoiceLineOb(
            ...
            assetCategoryId: 0,
            // element['asset_category_id'] == false
            //     ? 0
                      ...
                      appBar: AppBar(
                        ...
                        actions: [
                          Visibility(
                            visible: true,
                            child: TextButton(
                                onPressed: invoiceList[0]['invoice_date'] ==
                                        false
                                    ? () {
                                        final snackbar = SnackBar(
                                          ...
                                          content: const Text(
                                            'You need to post invoice before printing!',
                                    ...
                                    : () async {
                                        ...
                                        var bluetoothConnect = await Permission
                                            .bluetoothConnect.status;
                                        var bluetoothScan = await Permission
                                            ...
                                            if (await Permission
                                              ...
                                              Navigator.of(context).push(
                                                ...
                                                return Print(
                                                    ...
                                                    vrno: invoiceList[0]
                                                        ['name'],
                                                    terms: invoiceList[0]['invoice_payment_term_id'] == false
                                                        ? ''
                                                        : invoiceList[0]
                                                                ['invoice_payment_term_id']
                                                            [1],
                          ...
                          TextButton(
                              onPressed: () {
                                Navigator.of(context)
                                  ...
                                  return const RegisterPaymentPage();
                                }));
                              },
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                child: MediaQuery.of(context).size.width > 400.0
                                    ? SpeedDial(
                                        buttonSize: 80,
                          ...
                          children: [
                            ...
                            SpeedDialChild(
                              ...
                              onTap: () async {
                                ...
                                invoiceeditBloc.callactionpost(
                                    invoiceList[0]['id'], '');
                                await databaseHelper.deleteAllAccountMoveLine();
